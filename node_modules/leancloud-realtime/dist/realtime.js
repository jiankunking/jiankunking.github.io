...
function (_EventEmitter) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              return _context.abrupt("return", superagent(method, url).set(_objectSpread({
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 9:
              ...
              return _context4.abrupt("return", superagent.get('https://app-router.leancloud.cn/2/route').query({
                appId: appId
  ...
  Realtime._fetchRTMServers = function _fetchRTMServers(_ref7) {
    ...
    return this._getServerUrls({
      ...
      return superagent.get("".concat(RTMRouter, "/v1/route")).query({
        appId: appId,
        secure: ssl,
...
function (_EventEmitter) {
  ...
  function ConversationBase(_ref, client) {
    ...
    if (debug$6.enabled) {
      values(Event).forEach(function (event) {
...
var debug$9 = d('LC:SessionManager');
...
var _class$6;
var debug$b = d('LC:MessageParser');
  ...
  parse = function parse(content) {
    ...
    try {
      for (var _iterator = this._messageClasses[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        var contentCopy = isPlainObject(content) ? Object.assign({}, content) : content;
        var valid = void 0;
        var result = void 0;
