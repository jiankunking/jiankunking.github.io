...
title: RocketMQ 设计
abbrlink: 3227
date: 2020-12-13 13:02:56
tags:
---

> 消息存储、通信机制、消息过滤、负载均衡、事务消息、消息查询
> 转载自RocketMQ官方文档
<!-- more -->

### 1 消息存储

![](/images/rocketmq-design/rocketmq_design_1.png)
...
![](/images/rocketmq-design/rocketmq_design_2.png)
...
![](/images/rocketmq-design/rocketmq_design_3.png)
...
![](/images/rocketmq-design/rocketmq_design_4.png)
...
![](/images/rocketmq-design/rocketmq_design_5.png)

#### 2.4 Reactor多线程设计
RocketMQ的RPC通信采用Netty组件作为底层通信库，同样也遵循了Reactor多线程模型，同时又在这之上做了一些扩展和优化。

![](/images/rocketmq-design/rocketmq_design_6.png)
...
![](/images/rocketmq-design/rocketmq_design_7.png)
...
![](/images/rocketmq-design/rocketmq_design_10.png)
...
![](/images/rocketmq-design/rocketmq_design_11.png)
...
![](/images/rocketmq-design/rocketmq_design_12.png)
...
![](/images/rocketmq-design/rocketmq_design_13.png)
...
本文整理自：[https://github.com/apache/rocketmq/blob/master/docs/cn/design.md](https://github.com/apache/rocketmq/blob/master/docs/cn/design.md)
